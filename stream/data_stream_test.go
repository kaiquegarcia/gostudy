...
func Test_CSVDataStream_SmallerFile(t *testing.T) {
...
func Test_CSVDataStream_BiggerFile(t *testing.T) {
	file, _ := os.Open("file_bigger_than_buffer_test.csv")
	defer file.Close()
	...
	t.Run("should return headers on first call", func(t *testing.T) {
		...
		assert.Equal(t, "Header 1 ABCDEFGHIJKLMNOPQRSTUVWXYZ", row[0], "row[0] should be 'Header 1 ABCDEFGHIJKLMNOPQRSTUVWXYZ'")
		assert.Equal(t, "Header 2 ABCDEFGHIJKLMNOPQRSTUVWXYZ", row[1], "row[1] should be 'Header 2 ABCDEFGHIJKLMNOPQRSTUVWXYZ'")
		assert.Equal(t, "Header 3 ABCDEFGHIJKLMNOPQRSTUVWXYZ", row[2], "row[2] should be 'Header 3 ABCDEFGHIJKLMNOPQRSTUVWXYZ'")
		assert.Equal(t, "Header 4 ABCDEFGHIJKLMNOPQRSTUVWXYZ", row[3], "row[3] should be 'Header 4 ABCDEFGHIJKLMNOPQRSTUVWXYZ'")
	})
